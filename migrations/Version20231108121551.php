 ...
 */
final class Version20231108121551 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE journal (id INT NOT NULL, name VARCHAR(255) NOT NULL, issn VARCHAR(9) DEFAULT NULL, e_issn VARCHAR(9) DEFAULT NULL, url VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
